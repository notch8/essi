...
ActiveRecord::Schema.define(version: 20191009144806) do
  ...
  create_table "dynamic_schemas", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "m3_class"
  ...
  create_table "m3_contexts", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "name"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["m3_profile_context_id"], name: "index_m3_contexts_on_m3_profile_context_id"
    t.index ["m3_profile_id"], name: "index_m3_contexts_on_m3_profile_id"
  end

  create_table "m3_profile_available_properties", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "m3_profile_classes", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "name"
  ...
  create_table "m3_profile_classes_contexts", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.bigint "m3_profile_context_id"
    t.bigint "m3_profile_class_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "m3_profile_contexts", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "name"
    t.string "display_label"
    t.integer "m3_profile_id"
    t.datetime "created_at", null: false
  ...
  create_table "m3_profile_properties", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "name"
  ...
  create_table "m3_profile_texts", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "name"
    t.string "value"
    t.integer "m3_profile_property_id"
  ...
  create_table "m3_profiles", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "name"
