...
RSpec.describe M3::ProfileImporter do

  describe 'class attributes' do
    it '#default_logger' do
      M3::ProfileImporter.default_logger == Rails.logger
    end

    it '#default_config_file' do
      path_to_file = M3::ProfileImporter.default_config_file
  ...
  describe '#load_profile_from_path' do
    it 'returns an M3::Profile instance' do
      expect(M3::ProfileImporter.load_profile_from_path)
